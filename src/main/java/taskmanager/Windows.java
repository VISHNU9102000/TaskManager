...
public class Windows{
	public static ArrayList<String> value()throws IOException 
	{
		...
		try{
           ...
           String command = "powershell.exe Get-Process -Name * | Select-Object -Property Name, Id,@{Label = 'Memory'; Expression = {[math]::round($_.privatememorysize / 1mb)}},@{Name = 'CPUPercent';Expression = {$TotalSec = (New-TimeSpan -Start $_.StartTime).TotalSeconds;[Math]::Round( ($_.CPU * 100 / $TotalSec), 1)}}, Path|format-table -autosize";
